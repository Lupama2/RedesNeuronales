...
plt_entrenamiento_Kohonen(10, sigma, eta)
plt.savefig('Informe/ej3_fig2_1.png', bbox_inches='tight', dpi=300)

plt_entrenamiento_Kohonen(200, sigma, eta)
plt.savefig('Informe/ej3_fig2_2.png', bbox_inches='tight', dpi=300)

plt_entrenamiento_Kohonen(750, sigma, eta)
plt.savefig('Informe/ej3_fig2_3.png', bbox_inches='tight', dpi=300)

plt_entrenamiento_Kohonen(1750, sigma, eta)
plt.savefig('Informe/ej3_fig2_4.png', bbox_inches='tight', dpi=300)
